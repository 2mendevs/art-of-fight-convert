...
const FontLoader = () => (
  <style>{`
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .btn-teal:hover { background: #00a8be; }
    ...
    .checklist-item .check {
      color: #00bcd4; font-size: 20px; margin-top: 2px; flex-shrink: 0;
    }
...
const checklistItems: ChecklistItem[] = [
  { text: "Free 30-minute strategy call included" },
  { text: "No long-term contracts — cancel anytime" },
  { text: "Results guaranteed or coaching extended free" },
